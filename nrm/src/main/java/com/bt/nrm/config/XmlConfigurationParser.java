        ...
        private List<XmlConfigurationElement> getIncludedElements(String resource) {
            ...
            try {
                ...
                if (isEmpty(resourceAsStream))
                    throw new ConfigurationException("Could not find the included resources: " + resource);
                ...
                throw new ConfigurationException("Failed to process the Included resources " + resource, e);
            }
        }
