    ...
    private static synchronized <T> void loadConfig(Class<T> configClass, String environment) {
        ...
        try {
            if (null == resourceLocation) {
                throw new RuntimeException("Unable to load resources: " + resourceLocation +" from relativeResourcePath :"+relativeResourcePath);
            }
            ...
            throw new RuntimeException("Unable to load resources: " + resourceLocation, e);
        }
    }
