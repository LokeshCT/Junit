...
public class SqeAccessInputDetailsMatcher extends CompositeMatcher<SqeAccessInputDetails> {

    public static SqeAccessInputDetailsMatcher aSqeAccessInputDetail() {
        return new SqeAccessInputDetailsMatcher();
    }

    public SqeAccessInputDetailsMatcher withSiteDetails(String siteName, String city, String country, String postCode, String teplePhone,
                                                 ...
                                                 String street, String locality, String[] onNetBuildingIds, boolean decisionSupportFlag,Integer accuracyLevel){
        this.assertions.add(new SqeAccessInputSiteDetailsMatcher(siteName, city, country, postCode, teplePhone, longitude, latitude, countryISOCode,
                                                                 ...
                                                                 subCountyStateProvince, postalOrganisation, pOBox, stateCode, street, locality, onNetBuildingIds,
                                                                 decisionSupportFlag,accuracyLevel));
        return this;
    }

    public SqeAccessInputDetailsMatcher withPrimaryPortSpeed(String bandwidth) {
        this.assertions.add(new PrimaryPortBandwidthMatcher(bandwidth));
        return this;
    }

    public SqeAccessInputDetailsMatcher withPrimaryAccessTechnology(String accessTechnology) {
        this.assertions.add(new PrimaryAccessTechnologyMatcher(accessTechnology));
        return this;
    }

    public SqeAccessInputDetailsMatcher withSecondaryPortSpeed(String bandwidth) {
        this.assertions.add(new SecondaryPortBandwidthMatcher(bandwidth));
        return this;
    }

    public SqeAccessInputDetailsMatcher withPrimaryAccessSpeed(String bandwidth) {
        this.assertions.add(new PrimaryAccessSpeedBandwidthMatcher(bandwidth) );
        return this;
    }

    public SqeAccessInputDetailsMatcher withSecondaryAccessSpeed(String bandwidth) {
        this.assertions.add(new SecondaryAccessSpeedBandwidthMatcher(bandwidth) );
        return this;
    }

    public SqeAccessInputDetailsMatcher withAutoSelection(String autoSelection) {
        this.assertions.add(new AutoSelectionValueMatcher(autoSelection));
        return this;
    }

    public SqeAccessInputDetailsMatcher withUserDetails(String foreName, String surname, int ein, String emailId, String salesChannel) {
        this.assertions.add(new UserDetailsMatcher(foreName, surname, ein, emailId, salesChannel));
        return this;
    }

    public SqeAccessInputDetailsMatcher withSynchUri(String synchUri) {
        this.assertions.add(new SynchUriMatcher(synchUri));
        return this;
    }

    public SqeAccessInputDetailsMatcher withContractTerm(String contractTerm) {
        this.assertions.add(new ContractTermMatcher(contractTerm));
        return this;
    }

    public SqeAccessInputDetailsMatcher withPrimaryAccessTechSubType(String subType) {
        this.assertions.add(new PrimaryAccessSubTypeMatcher(subType));
        return this;
    }

    public SqeAccessInputDetailsMatcher withMBPFlag(String mbpFlag) {
        this.assertions.add(new MBPFlagMatcher(mbpFlag));
        return this;
    }

    public SqeAccessInputDetailsMatcher withQuoteType(String quoteType) {
        this.assertions.add(new QuoteTypeMatcher(quoteType));
        return this;
    }

    public SqeAccessInputDetailsMatcher withAttributeMultiValues(String attributeName,String[] attributeValues) {
        this.assertions.add(new MultiValueAttributeMatcher(attributeName,attributeValues));
        return this;
    }

    private class SqeAccessInputSiteDetailsMatcher extends TypeSafeMatcher<SqeAccessInputDetails> {
        ...
        @Override
        public boolean matchesSafely(SqeAccessInputDetails sqeAccessInput) {
            ...
            for(int i =0; i<listOfOnNetBuildingCodes.length;i++){
                if( !eq(onNetBuildingCode[i], listOfOnNetBuildingCodes[i].getOnNetBuildingCode()) ) {
                    failure = format("On-net building code %s doesn't match with %s",listOfOnNetBuildingCodes[i].getOnNetBuildingCode(), onNetBuildingCode[i]);
                }
            }
    ...
    private abstract class AbstractAccessInputMatcher extends TypeSafeMatcher<SqeAccessInputDetails> {
        ...
        protected abstract String getActualValue(SqeAccessInputDetails sqeAccessInput);
    ...
    private class PrimaryPortBandwidthMatcher extends AbstractAccessInputMatcher{
        ...
        @Override
        protected String getActualValue(SqeAccessInputDetails sqeAccessInput) {
    ...
    private class MBPFlagMatcher extends AbstractAccessInputMatcher {

        public MBPFlagMatcher(String mbpFlag) {
            super(mbpFlag);
        }

        @Override
        protected String getActualValue(SqeAccessInputDetails sqeAccessInput) {
            return String.format("%s", sqeAccessInput.getQuoteInput()[0].getMBPFlag());
        }
    ...
    private class QuoteTypeMatcher extends AbstractAccessInputMatcher {

        public QuoteTypeMatcher(String mbpFlag) {
            super(mbpFlag);
        }

        @Override
        protected String getActualValue(SqeAccessInputDetails sqeAccessInput) {
            return String.format("%s", sqeAccessInput.getQuoteInput()[0].getQuoteType());
        }
    ...
    private class UserDetailsMatcher extends TypeSafeMatcher<SqeAccessInputDetails> {
    ...
    private class MultiValueAttributeMatcher extends TypeSafeMatcher<SqeAccessInputDetails>  {

        private String attributeName;
        private String[] attributeValues;
        private String failure;
        public MultiValueAttributeMatcher(String attributeName,String[] attributeValues) {
            this.attributeName = attributeName;
            this.attributeValues = attributeValues;
        }

        @Override
        public boolean matchesSafely(SqeAccessInputDetails sqeAccessInputDetails) {

            SqeQuoteInputDetails sqeQuoteInputDetails = sqeAccessInputDetails.getQuoteInput()[0];

            String[] listOfGpopInclude = sqeQuoteInputDetails.getListOfGpopInclude();

            for(int i =0; i<listOfGpopInclude.length;i++){
                if( !eq(attributeValues[i], listOfGpopInclude[i]) ) {
                    failure = format("attribute - %s value is %s doesn't match with %s",attributeName,listOfGpopInclude[i], attributeValues[i]);
                }
            }
