...
import com.bt.usermanagement.ldap.model.LdapSearchListModel;
...
@Path("/user-management/searchBTDirectory")
...
public class SearchBTDirectoryHandler {
    ...
    @GET
    @Path("/ein/{ein}")
    public Response search(@PathParam("ein") String ein) throws LdapSearchException{
    ...
    public List<LdapSearchModel> searchBTDirectory(Map<String, String> args) throws LdapSearchException {
        List<LdapSearchModel> resultList = new ArrayList<LdapSearchModel>();
        try {

            resultList = repository.search(args);
        }catch(LdapSearchException lse){
            throw new LdapSearchException("Ldap Context Not Found", lse);
        }catch (Exception e) {
            LOGGER.logError(e);
        }
        return resultList;
   ...
   // @Path("/ein/{ein}/firstName/{firstName}/lastName/{lastName}/email/{email}/search")
    ...
    public Response searchDirectory(@QueryParam(LDAPConstants.EIN) String ein, @QueryParam(LDAPConstants.FIRST_NAME) String firstName, @QueryParam(LDAPConstants.LAST_NAME) String lastName, @QueryParam(LDAPConstants.EMAIL) String email) {
