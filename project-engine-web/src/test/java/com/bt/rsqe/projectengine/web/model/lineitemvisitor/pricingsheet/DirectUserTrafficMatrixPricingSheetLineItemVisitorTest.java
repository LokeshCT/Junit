...
public class DirectUserTrafficMatrixPricingSheetLineItemVisitorTest {
    ...
    public void shouldGetDataFromLineItem() throws Exception {
        LineItemVisitor visitor = new DirectUserTrafficMatrixPricingSheetLineItemVisitor(onNetTable, offNetTable, uniqueDataSet);
    ...
    public void shouldGetOffNetValuesFromProjectedUsageModel() throws Exception {
        ...
        LineItemVisitor visitor = new DirectUserTrafficMatrixPricingSheetLineItemVisitor(null, offNetTable, uniqueDataSet);
    ...
    public void shouldGetOnNetValuesFromProjectedUsageModel() throws Exception {
        ...
        LineItemVisitor visitor = new DirectUserTrafficMatrixPricingSheetLineItemVisitor(onNetTable, null, uniqueDataSet);
