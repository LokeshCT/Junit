...
public class IndirectUserPricingSheetVisitorTest {
    ...
    public void before() {
        ...
        output = newHashMap();
        stubChildren();
        visitor = new IndirectUserPricingSheetVisitor(productInstance, output, priceLineAggregator, lineItemVisitorFactory, null);
    ...
    private void stubLineItemAndVisitors() {
        ...
        when(lineItem.getStencil(any(String.class))).thenReturn("resilience");
    ...
    private void stubChildren() {
        ...
        productInstance = DefaultProductInstanceFixture.aProductInstance()
                                                       ...
                                                       .withProductIdentifier(ProductCodes.ConnectAccelerationSite.productCode(), ProductCodes.ConnectAccelerationSite.productName())
        ...
        ProductInstance steelHeadOne = DefaultProductInstanceFixture.aProductInstance()
                                                                    .withProductIdentifier(new ProductIdentifier(ProductCodes.ConnectAccelerationSteelhead.productCode(), "1.0"))
        ...
        final SalesRelationshipFixture steelHeadSalesRelationshipFixture = SalesRelationshipFixture.aSalesRelationship()
                                                                                                   ...
                                                                                                   .withProductIdentifier(ProductCodes.ConnectAccelerationSteelhead.productCode());
